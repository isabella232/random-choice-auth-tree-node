...
A simple authentication node for ForgeRock's [Identity Platform][forgerock_platform] 5.5 and above. This node chooses a random outcome from a list. Outcomes can be weighted to skew the random choice, for example, to force strong authentication 1 in every 10 logins.  
